...
![](images/ex7_new_rmd_dialog.png){alt="The New R Markdown dialogue with the Title and Author filled in and PDF circled under Default Output Format"}
...
![](images/ex7_knit_menu.png){alt="The Knit button at the top of the editor with its dropdown menu open, the button and Knit to PDF both circled"}
...
![](images/ex7_rmd_anatomy.png){alt="An R markdown file open in the editor with the YAML header, the text and the two code chunks each boxed and labelled"}
...
The `sessionInfo()` function writes all of that down for you. It prints your R version, your operating system, and every package that was loaded when the document was knitted, along with its version number. See [Section 1.10](https://intro2r.com/proj_doc.html#proj_doc) of the book for more explanation. Add a heading at the very end of your report, `## Session information`, and a code chunk underneath it that calls `sessionInfo()`.
