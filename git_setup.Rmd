...
**You do not need this at the start of the course.** It is needed for Exercise 9, and there is no advantage in doing it earlier; the access token you create in Step 5 has a limited life, so setting it up months in advance only means renewing it sooner.
