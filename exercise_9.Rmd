...
b) In RStudio, create a new R script (`File` -> `New File` -> `R Script`) and save it as `cardiac_analysis.R`. In it, import the data with `read.table()` as you did in **Exercise 3, Q5**, and draw the boxplot of total cholesterol by smoking status from **Exercise 5, Q11**. Do not forget the factor recoding from **Exercise 5, Q4**. Save the file.
