...
## Exercise (optional): Basic programming in R
...
2\. Write a function to convert Fahrenheit to centigrade (oC = (oF - 32) x 5/9). Get your function to print out both the temperature you gave it and the converted value, each with a label, so the result reads something like "Fahrenheit: 60 oF" followed by "Centigrade: 15.556 oC".
