...
One more thing while you're in there. Later in this exercise you'll want a couple of functions from the `knitr` package, and the tidy place for a `library()` call is at the top of a document rather than buried in the middle of it. Add `library(knitr)` to your `setup` chunk now, the one you kept back in Q2, and you won't have to think about it again.
