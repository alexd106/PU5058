...
knitr::purl('./linear_model_3_exercise_solutions.Rmd', output = './exercise_solutions/linear_model_3_multiple_exercise_solutions.R', quiet = TRUE)
knitr::purl('./linear_model_4_exercise_solutions.Rmd', output = './exercise_solutions/linear_model_4_Selection_exercise_solutions.R', quiet = TRUE)
