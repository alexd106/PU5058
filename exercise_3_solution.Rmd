...
Now, why the new variable rather than the tidier looking overwrite? Have a think about it before you reveal the answer.
...
b) Next, extract all rows except the first 10 rows and all columns except the last column. Careful here, which column is the last one now? Remember, you can specify the columns you want either by position or by name. Practice both ways. Do you have a preference? If so why? 
